"""
      ...
      task1_4_starter.py   - Dictionaries and working with files

      This solution attempts to read from alice.txt (Alice's Adventures in Wonderland)
      and display the most frequent 100 words that are 5 characters or greater
